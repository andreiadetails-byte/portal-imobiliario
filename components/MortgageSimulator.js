  ...
  return (
    <div className="card" style={{ padding: 22, marginTop: 8 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4, flexWrap: 'wrap', gap: 8 }}>
        ...
        <button
          type="button"
          onClick={() => setMode(mode === 'prestacao' ? 'quanto' : 'prestacao')}
      ...
      {mode === 'prestacao' ? (
        <div style={{ background: 'var(--plaster)', borderRadius: 8, padding: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10, marginTop: 6 }}>
          <div>
        ...
        <div style={{ background: 'var(--plaster)', borderRadius: 8, padding: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10, marginTop: 6 }}>
          <div>
            ...
            <div style={{ fontSize: 15, fontWeight: 600 }}>{maxLoan.toLocaleString('pt-PT', { maximumFractionDigits: 0 })} €</div>
          </div>
          <div>
