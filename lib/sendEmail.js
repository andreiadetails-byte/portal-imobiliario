...
// O endereço que aparece como remetente. Com um serviço como o Resend, o
// "utilizador" do SMTP é uma palavra fixa (ex.: "resend") e NÃO um email —
// por isso o remetente tem de poder ser definido à parte, em SMTP_FROM.
// Se SMTP_FROM não existir, tudo funciona como antes (usa SMTP_USER).
function getSenderAddress() {
  return process.env.SMTP_FROM || process.env.SMTP_USER || process.env.GMAIL_USER;
}
